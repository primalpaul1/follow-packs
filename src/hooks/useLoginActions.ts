...
export function generateNostrConnectURI(params: NostrConnectParams, appName?: string): string {
  ...
  // Add callback URL on mobile web so signer can redirect back
...
export function useLoginActions() {
  ...
  return {
    ...
    // The client displays a QR/button and waits for the remote signer to connect
